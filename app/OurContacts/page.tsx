          ...
          <div className="">
            ...
            <div className="w-full flex justify-end my-10">
              <div className="w-full lg:w-1/2 text-xl ">
                <p>
                  Connecting with the Three C&apos;s Met International Institute
                  of Mediation, Negotiation, Counseling, and Conciliation
                  (CCCMII) is the gateway to exploring a world where conflict
                  resolution and communication are revolutionized. We have
                  streamlined our contact information to ensure that you can
                  reach out to us with ease for any inquiries, support, or
                  feedback that you may have. Here&apos;s how you can get in
                  touch with us:
                </p>
                ...
                <div className="w-full">
                  <form className="w-full py-10   border-t-[1px] border-b-2 border-black flex  justify-end">
                    <div className="flex justify-between md:w-1/2 flex-col gap-y-4 mt-10  text-xl">
                      ...
                      <p>
                        For your convenience, we also provide an online contact
                        form on our website. Fill in your details and submit
                        your message, and one of our representatives will get
                      ...
                      <p className="mb-8">
                        ...
                        we&apos;re here to assist. Reach out today and take your
                        first step towards making a positive change in the
                        world.
                      </p>
                      <Input
