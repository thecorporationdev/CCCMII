            ...
            <div className="w-full lg:w-1/2 text-xl">
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li>
                  ...
                  emotional intelligence as a cornerstone of effective
                  mediation.
                </li>
                <li>
                ...
                <li>
                  ...
                  continuously evolve our methodologies and practices to stay at
                  the forefront of mediation techniques and negotiation
                  strategies.
                </li>
                <li>
          ...
          <div className="w-full flex my-10 justify-end">
            <div className=" w-full lg:w-1/2 text-xl space-y-4">
              ...
              <p>
                ...
                problem-solving are universal keys to unlocking lasting peace
                and concord.
              </p>
              <p>
                Through our commitment to excellence, integrity, and empathetic
                engagement, CCCMII continues to set the standard for
                professional development in mediation and conflict
